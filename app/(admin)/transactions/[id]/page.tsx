            ...
            <div className="bg-gray-800 rounded-2xl border border-gray-700/50 overflow-hidden">
              ...
              <div className="p-6">
                ...
                {booking.status === 'COMPLETED' ? (
                  ...
                  <div className="flex items-center gap-2 p-3 bg-blue-900/30 border border-blue-800 rounded-lg text-blue-400 text-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    Tambah sparepart &amp; set harga DP, lalu klik &quot;Kirim Tagihan DP&quot;
                  </div>
                ) : booking.status === 'TESTING' ? (
                  <div className="flex items-center gap-2 p-3 bg-blue-900/30 border border-blue-800 rounded-lg text-blue-400 text-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    Set harga pelunasan lalu klik &quot;Kirim Tagihan Pelunasan&quot;
                  </div>
